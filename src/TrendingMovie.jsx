...
import { fetchAllTrendingMovies } from "./redux/actions/movieActions";

export default function TrendingMovie() {
  const dispatch = useDispatch();
  const allTrendingMovies = useSelector(
    (state) => state.movies.allTrendingMovies
  ); // Mengambil data allTrendingMovies dari Reducers menggunakan useSelector
  const navigate = useNavigate();

  // Mengambil semua data Trending Movies dari Actions
  useEffect(() => {
