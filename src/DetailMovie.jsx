...
export default function DetailMovie() {
  ...
  const { detailMovieData, isLoading } = useSelector((state) => state.detail); // Mengambil data dari Reducers menggunakan useSelector
        ...
        <section>
          <div className="mt-60" key={detailMovieData?.title}>
            <div className="absolute top-0 w-full h-screen flex items-center justify-center">
              ...
              />
              <div className="absolute p-24 w-full h-screen bg-black/80 flex items-center">
