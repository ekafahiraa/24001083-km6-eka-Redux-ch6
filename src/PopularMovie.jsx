...
export default function PopularMovie() {
  ...
  const allPopularMovies = useSelector(
    (state) => state.movies.allPopularMovies
  ); // Mengambil data allPopularMovies dari Reducers menggunakan useSelector

  // Mengambil semua data allPopularMovies dari Actions
  useEffect(() => {
    dispatch(fetchAllPopularMovies());
  }, [dispatch]);
