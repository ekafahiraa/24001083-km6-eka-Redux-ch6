...
export default function UpcomingMovie() {
  ...
  const upcomingMovies = useSelector((state) => state.movies.upcomingMovies); // Mengambil data allupcomingMovies dari Reducers menggunakan useSelector

  // Mengambil semua data Upcoming Movies dari Actions
  useEffect(() => {
